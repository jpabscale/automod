...
//> using dep com.fasterxml.jackson.core:jackson-databind:2.21.0
//> using dep com.fasterxml.jackson.dataformat:jackson-dataformat-toml:2.21.0
//> using jar lib/luaj-jse-1.0.0.jar
//> using dep com.jayway.jsonpath:json-path:2.10.0
//> using dep org.apache.bcel:bcel:6.12.0
//> using dep org.graalvm.polyglot:js:25.0.2
//> using dep org.graalvm.polyglot:polyglot:25.0.2
//> using dep org.graalvm.polyglot:python:25.0.2
